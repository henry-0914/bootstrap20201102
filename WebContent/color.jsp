...
<div class="container">
	...
	<h1 class="bg-danger text-white">Voluptatibus ipsum eveniet!</h1>
	<h1 class="bg-secondary">Non beatae accusantium?</h1>
	<h1 class="bg-dark text-light">Ullam cumque maxime.</h1>
	<h1 class="bg-light">Qui quia odio.</h1>
